...
var HELICOPTER = (function() {
    ...
    function mainLoop() {
        ...
        if (state === Heli.State.PLAYING) { 
            ...
            dialog("Tap screen to start again.");
    ...
    function init(wrapper, root) {
        ...
        canvas.setAttribute("width", "850px");
    ...
    function startScreen() { 
        ...
        ctx.fillText("tap screen to start", x + 5, y + 66);
        ctx.fillText("©2011 Invreon MobiApps", x + 5, y + 145);
        ctx.fillText("scoring isn't supported just yet, but will be soon.", x + 5, y + 99);
    };                      
